...
(`features/settings.md`). The grid always opens scrolled to the top
(12 AM) regardless of any Sleep/Leisure block — an earlier "never open on
a Sleep hour" initial-scroll behavior was removed (2026-08-16, direct
request), `static/time_blocks.js` now only ever warns, never scrolls.
